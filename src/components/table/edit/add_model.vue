    ...
    *提出时间：
    ...
    <table border="1" cellspacing="0px" style="border-collapse:collapse;width: 100%">
      ...
      <tr>
        <td>申请人</td>
        <td style="border: 0px">
          <table style="border-collapse:collapse;width: 100%;border-top: none;border-bottom: none;border-left: none" border="1" >
            <tr>
              <td width="80px"> * 姓名</td>
              <td colspan="3">
            ...
            <tr>
              <td>*联系方式</td>
              <td>
                <Input v-model="singleData.sqrlxfs"  @on-change="checkNumber(singleData.sqrlxfs)"  placeholder="Enter something..." clearable  style="width: 100%" />
              ...
              <td style="vertical-align: top;">
                <Input v-model="singleData.sqryx" @on-change="checkEmail(singleData.sqryx)"  placeholder="Enter something..." clearable  style="width: 100%" />
      ...
      <tr>
        <td>*专业类别</td>
        <td><Cascader :data="ywy" v-model="singleData.zylb" trigger="hover" ></Cascader>
          <span style="color: red" v-if="singleData.zylb==''">至少选择一个专业</span>
        </td>
      </tr>
      <tr>
        <td>*需求单分类</td>
        <td><Checkbox-group v-model="singleData.xqdfl" >
          <Checkbox label="政策性需求"><Tooltip content="政策性需求">政策性需求</Tooltip></Checkbox>
          <Checkbox label="新业务需求"><Tooltip content="新业务需求">新业务需求</Tooltip></Checkbox>
          <Checkbox label="新技术需求"><Tooltip content="新技术需求">新技术需求</Tooltip></Checkbox>
          <Checkbox label="系统优化需求"><Tooltip content="系统优化需求">系统优化需求</Tooltip></Checkbox>
        </Checkbox-group>
      ...
      <tr>
        <td>*需求单综述</td>
        <td><i-input v-model="singleData.xqzs" type="textarea" :rows="8" placeholder="请输入..."></i-input>
      ...
      <tr>
        <td>*期望完成日期</td>
        <td><Date-picker v-model="singleData.qwwcsj" type="date" placeholder="选择日期" style="width: 100%"></Date-picker>
          <span style="color: red" v-if="singleData.qwwcsj==''">期望完成日期必填</span>
        </td>
      </tr>
      <tr>
        <td>*部门级别</td>
        <td><Radio-group v-model="disabledGroup">
            ...
            <tr>
              ...
              <td>
                <table style="width:100%;border-style:hidden;" border="1" cellspacing="0px" >
                  ...
                  <tr align="center">
                    <td>输出</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywqwsc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywsnsc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywdssc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywdsfsc" /></td>
                  </tr>
                  <tr align="center">
                    <td>流程流转</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywqwlz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywsnlz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywdslz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywdsflz" /></td>
                  </tr>
                  <tr align="center">
                    <td>执行角色</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywqwzx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywsnzx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywdszx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ssywdsfzx" /></td>
                  </tr>
                </table>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <table style="width:100%;border-style:hidden;" border="1" cellspacing="0px">
                  ...
                  <tr align="center">
                    <td>输出</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcqwsc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcsnsc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcdssc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcdsfsc" /></td>
                  </tr>
                  <tr align="center">
                    <td>流程流转</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcqwlz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcsnlz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcdslz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcdsflz" /></td>
                  </tr>
                  <tr align="center">
                    <td>执行角色</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcqwzx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcsnzx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcdszx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.ywlcdsfzx" /></td>
                  </tr>
                </table>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <table style="width:100%;border-style:hidden;" border="1" cellspacing="0px">
                  ...
                  <tr align="center">
                    <td>输出</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjdqwsc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjdsnsc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjddssc" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjddsfsc" /></td>
                  </tr>
                  <tr align="center">
                    <td>流程流转</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjdqwlz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjdsnlz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjddslz" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjddsflz" /></td>
                  </tr>
                  <tr align="center">
                    <td>执行角色</td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjdqwzx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjdsnzx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjddszx" /></td>
                    <td style="text-align:center;"><Checkbox v-model="ywyList.lcjddsfzx" /></td>
                  </tr>
                </table>
              </td>
            </tr>
